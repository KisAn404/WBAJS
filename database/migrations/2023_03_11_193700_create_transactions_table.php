...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('transactions', function (Blueprint $table) {
            ...
            $table->string('src_of_fund')->nullable();
            $table->enum('type', ['deposit', 'collection', 'expense'])->nullable();
            $table->date('date')->nullable();
            $table->string('payer/payee')->nullable();
            ...
            $table->string('depositedIn')->nullable();
